...
class Invoice extends Model {
    protected $fillable = ['invoice_number', 'client_id', 'status', 'anulation_type', 'cancellation_reason', 'cancelled_at', 'issue_date', 'due_date', 'subtotal', 'tax_rate', 'tax_amount', 'discount_type', 'discount_value', 'discount_amount', 'total', 'amount_paid', 'currency', 'exchange_rate', 'notes', 'terms', 'pdf_path', 'sent_at', 'sent_via', 'viewed_at', 'paid_at', 'recurring_id', 'created_by', 'payment_token', 'payment_token_expires_at', 'is_ecf', 'ecf_type', 'tipo_ingresos', 'modified_ncf', 'modification_code', 'modification_reason', 'nota_credito_indicator', 'encf', 'dgii_status', 'dgii_track_id', 'security_code', 'signed_xml_path', 'dgii_error_messages', 'signed_at'];
    protected $casts = ['issue_date' => 'date', 'due_date' => 'date', 'sent_at' => 'datetime', 'viewed_at' => 'datetime', 'paid_at' => 'datetime', 'payment_token_expires_at' => 'datetime', 'signed_at' => 'datetime', 'cancelled_at' => 'datetime'];
