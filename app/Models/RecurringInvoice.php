...
class RecurringInvoice extends Model {
    protected $fillable = ['client_id', 'frequency', 'status', 'start_date', 'end_date', 'next_issue_date', 'occurrences_limit', 'occurrences_count', 'subtotal', 'tax_rate', 'currency', 'ecf_type', 'tipo_ingresos', 'auto_send', 'send_via', 'notes', 'terms', 'created_by'];
