...
class DgiiDeclarationService
{
    ...
    public function generateItcExcel(string $year, string $month): Spreadsheet
    {
        ...
        // Logo Oficial DGII original extraído de la plantilla
        ...
        // Separador vertical doble entre el logo y el membrete (idéntico al original)
        $sheet->getStyle('C2:C4')->getBorders()->getRight()->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_DOUBLE);

        // Altura proporcional de filas para garantizar que el texto respire y no se recorte
        ...
        // Código de declaración a la derecha
        $sheet->mergeCells('X2:AC4');
