    ...
    <div id="app-splash" aria-hidden="false">
        <div class="splash-container">
            <svg id="splash-logo" class="splash-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 437.18 523.89" aria-label="Bills">
                ...
                <path class="splash-logo-text" fill="#111827" d="M305.17,508.49c1.05,10.29,7.7,14.75,16.53,14.75,7.94,0,12.56-3.81,14.34-8.92l10.46,1.46c-2.92,8.92-11.59,15.24-25.04,15.24-17.18,0-27.47-11.35-27.47-26.66s10.37-26.34,26.42-26.34c17.5,0,26.18,11.92,25.45,28.69h-40.68ZM333.62,501.03c-.49-7.94-5.27-11.83-14.26-11.83-8.19,0-13.38,4.05-14.18,11.83h28.44Z"></path>
                <path class="splash-logo-text" fill="#111827" d="M361.34,513.68c.89,4.46,3.4,8.51,9.4,8.51,4.46,0,7.13-2.19,7.13-5.27,0-3-2.84-4.29-6.97-5.11l-7.38-1.46c-7.62-1.54-12.72-5.59-12.72-13.45,0-8.67,7.21-14.91,18.4-14.91,11.27,0,17.42,6.57,17.91,14.75l-10.7.65c-.4-4.05-2.67-7.46-7.38-7.46-4.21,0-6.4,2.11-6.4,4.78,0,2.67,2.27,4.05,5.92,4.78l7.38,1.46c8.59,1.7,13.78,5.59,13.78,13.94,0,9.97-7.94,15.64-19.45,15.64-12.4,0-18.72-6.57-19.61-16.13l10.7-.73Z"></path>
            </svg>
